    ...
    ...documentColumns,
    {
      ...
      render: (row) => (
        <div className="dashboard-inline-actions">
          ...
          <button type="button" className="btn btn-ai-summary" onClick={() => handleSummary(row.id)}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4M8 16h.01M16 16h.01"/></svg> Summary</button>
        </div>
      ),
    },
  ];
