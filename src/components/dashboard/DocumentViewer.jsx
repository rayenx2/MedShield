      ...
      <div className="docviewer-shell" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="docviewer-header">
          ...
          <div className="docviewer-controls">
            ...
            <button type="button" className="docviewer-btn docviewer-close-btn" onClick={onClose} title="Close"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
          </div>
        </div>
        ...
        >
          {isPdf ? (
            ...
            <div className="docviewer-unsupported">
              <p className="docviewer-unsupported-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></svg></p>
