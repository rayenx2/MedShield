  ...
  if (variant === 'banner') {
    return (
      <svg width={size * 1.8} height={size * 0.35} viewBox="0 0 400 70" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.2))' }}>
        <rect x="0" y="0" width="400" height="70" rx="8" fill="#007f8c" />
        ...
        <text x="75" y="28" fontSize="18" fontWeight="900" fontFamily="'Plus Jakarta Sans','Segoe UI',sans-serif" fill="white" letterSpacing="2">MEDSHIELD</text>
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 220 220">
      ...
      <text fontSize="13" fontWeight="900" fontFamily="'Plus Jakarta Sans','Segoe UI',sans-serif" fill="#007f8c" letterSpacing="7.5" filter={`url(#ink${uid})`}>
        <textPath href={`#ta${uid}`} startOffset="50%" textAnchor="middle">MEDSHIELD</textPath>
      </text>
      ...
      <circle cx="25" cy="113" r="2.5" fill="#007f8c" filter={`url(#ink${uid})`} />
      <circle cx="195" cy="113" r="2.5" fill="#007f8c" filter={`url(#ink${uid})`} />
